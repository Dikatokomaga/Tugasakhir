        ...
        <div class="card-body">
          <form method="POST">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" readonly class="form-control" id="Sekolah" name="Sekolah" value="<?= $data_sekolah->nama_sekolah ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" readonly class="form-control" id="alamat_sekolah" name="alamat_sekolah" value="<?= $data_sekolah->alamat_sekolah; ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="url" readonly class="form-control" id="web" name="web" value="<?= $data_sekolah->web; ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" readonly class="form-control" id="no_wa" name="no_wa" value="<?= $data_sekolah->no_wa; ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" readonly class="form-control" id="no_kontak" name="no_kontak" value="<?= $data_sekolah->no_kontak; ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="email" readonly class="form-control" id="email" name="email" value="<?= $data_sekolah->email; ?>">
